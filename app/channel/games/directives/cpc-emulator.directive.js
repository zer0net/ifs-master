	...
	function($location,$rootScope,$timeout) {
		...
		var controller = function($scope,$element) {
			...
			$scope.initCpcEmulator = function(game){
				if (game) { $scope.game = game; }
				$scope.file = '/'+Page.site_info.address + '/' + $scope.game.path;
				$timeout(function () {
					$scope.loadScript('assets/lib/games/cpcbox/jquery-1.8.3.min.js', 'text/javascript', 'utf-8');
					$scope.loadScript('assets/lib/games/cpcbox/jquerytools.rangeinput.js', 'text/javascript', 'utf-8');
					$scope.loadScript('assets/lib/games/cpcbox/inflate.js', 'text/javascript', 'utf-8');
					$scope.loadScript('assets/lib/games/cpcbox/cpcbox.sysroms.js', 'text/javascript', 'utf-8');
					$scope.loadScript('assets/lib/games/cpcbox/cpcbox.decrypted.js', 'text/javascript', 'utf-8');
				});
			};
		};
		...
		var template =  '<div class="main-panel" id="cpc-emulator-container">' +						
									...
									'<div id="option-panel-content">' +
										...
										'<div class="option-list">' +
											...
											'<label for="keyboard1" class="option-label">' +
												'<img src="assets/img/flag_uk.png" class="option-flag" />' +
											...
											'<label for="keyboard2" class="option-label">' +
												'<img src="assets/img/flag_france.png" class="option-flag" />' +
											...
											'<label for="keyboard3" class="option-label">' +
												'<img src="assets/img/flag_spain.png" class="option-flag" />' +
							...
							'<fieldset id="fieldset-tape" style="display:none">' +
								...
								'<div id="tape-choose" class="button-size2 button" onclick="$(\'#tape-input\').click();"><img src="assets/img/Open_16x16.png"/></div>' +
							...
							'<fieldset id="fieldset-drivea" style="display:none">' +
								...
								'<div id="drivea-choose" class="button-size2 button" onclick="$(\'#drivea-input\').click();"><img src="assets/img/Open_16x16.png"/></div>' +
							...
							'<fieldset id="fieldset-driveb" style="display:none">' +
								...
								'<div id="driveb-choose" class="button-size2 button" onclick="$(\'#driveb-input\').click();"><img src="assets/img/Open_16x16.png"/></div>' +
